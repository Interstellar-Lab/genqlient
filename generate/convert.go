	...
	case ast.Scalar:
		...
		return nil, errorf(
			pos, "unknown scalar %v: please add it to \"bindings\" in genqlient.yaml"+
				"\nExample: https://github.com/Interstellar-Lab/genqlient/blob/main/example/genqlient.yaml#L12", def.Name)
	default:
			...
			case *goStructType, *goInterfaceType:
				...
				return nil, errorf(nil,
					"genqlient doesn't allow duplicate fields with different selections "+
						"(see https://github.com/Interstellar-Lab/genqlient/issues/64); "+
