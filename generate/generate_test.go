		...
		t.Run(sourceFilename, func(t *testing.T) {
			generated, err := Generate(&Config{
				...
				Bindings: map[string]*TypeBinding{
					"ID":       {Type: "github.com/Interstellar-Lab/genqlient/internal/testutil.ID"},
					"DateTime": {Type: "time.Time"},
					"Date": {
						Type:        "time.Time",
						Marshaler:   "github.com/Interstellar-Lab/genqlient/internal/testutil.MarshalDate",
						Unmarshaler: "github.com/Interstellar-Lab/genqlient/internal/testutil.UnmarshalDate",
					},
					"Junk":        {Type: "interface{}"},
					"ComplexJunk": {Type: "[]map[string]*[]*map[string]interface{}"},
					"Pokemon": {
						Type:              "github.com/Interstellar-Lab/genqlient/internal/testutil.Pokemon",
						ExpectExactFields: "{ species level }",
					},
					"PokemonInput": {Type: "github.com/Interstellar-Lab/genqlient/internal/testutil.Pokemon"},
				},
...
func TestGenerateWithConfig(t *testing.T) {
	tests := []struct {
		...
		{"CustomContext", "", nil, &Config{
			ContextType: "github.com/Interstellar-Lab/genqlient/internal/testutil.MyContext",
		}},
		{"CustomContextWithAlias", "", nil, &Config{
			ContextType: "github.com/Interstellar-Lab/genqlient/internal/testutil/junk---fun.name.MyContext",
		}},
		...
		{"ClientGetter", "", nil, &Config{
			ClientGetter: "github.com/Interstellar-Lab/genqlient/internal/testutil.GetClientFromContext",
		}},
		{"ClientGetterCustomContext", "", nil, &Config{
			ClientGetter: "github.com/Interstellar-Lab/genqlient/internal/testutil.GetClientFromMyContext",
			ContextType:  "github.com/Interstellar-Lab/genqlient/internal/testutil.MyContext",
		}},
		{"ClientGetterNoContext", "", nil, &Config{
			ClientGetter: "github.com/Interstellar-Lab/genqlient/internal/testutil.GetClientFromNowhere",
			ContextType:  "-",
		}},
		...
		{"OptionalGeneric", "", []string{"ListInput.graphql", "QueryWithSlices.graphql"}, &Config{
			Optional:            "generic",
			OptionalGenericType: "github.com/Interstellar-Lab/genqlient/internal/testutil.Option",
		}},
