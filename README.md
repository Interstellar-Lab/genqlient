...
[![Go Reference](https://pkg.go.dev/badge/github.com/Interstellar-Lab/genqlient.svg)](https://pkg.go.dev/github.com/Interstellar-Lab/genqlient)
[![Test Status](https://github.com/Interstellar-Lab/genqlient/actions/workflows/go.yml/badge.svg)](https://github.com/Interstellar-Lab/genqlient/actions)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](docs/CODE_OF_CONDUCT.md)
[![GoReportcard](https://goreportcard.com/badge/github.com/Interstellar-Lab/genqlient?status.svg)](https://goreportcard.com/report/github.com/Interstellar-Lab/genqlient)
...
- Production-readiness: genqlient is used in production at Interstellar-Lab Academy, where it supports millions of learners and teachers around the world.

## How do I use genqlient?

You can download and run genqlient the usual way: `go run github.com/Interstellar-Lab/genqlient`.  To set your project up to use genqlient, see the [getting started guide](docs/INTRODUCTION.md), or the [example](example).  For more complete documentation, see the [docs](docs).
